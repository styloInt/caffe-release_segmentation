...
class RV_layer(caffe.Layer):
    ...
    def setup(self, bottom, top):
        ...
        self.irm_dir = params['rv_dir'] + '/IRM'
        self.segment_dir = params['rv_dir'] + '/Segment_GT'
    ...
    def load_image(self, idx):
        ...
        """
        im = Image.open('{}/{}'.format(self.irm_dir, idx))
    ...
    def load_label(self, idx):
        ...
        """
        label = img_as_uint(Image.open('{}/{}'.format(self.segment_dir, idx)))
